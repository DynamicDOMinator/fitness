...
"
        ...
        <div className=" lg:w-[40%] mt-30 lg:mt-0">
          ...
          >
            ...
            <div
              className={`w-[40px] h-[8px] mt-30 absolute right-[57%] md:right-[55%] lg:right-0 md:top-72 top-60 lg:left-5 z-[1000] transition-all duration-500 ease-out cursor-pointer rounded-full ${
                currentTrainer === 0
                  ? "bg-orange-500"
            ...
            ></div>
            <div
              className={`w-[40px] h-[8px] right-1/2 lg:right-0 mt-30 absolute md:top-72 top-60  lg:left-16 z-[1000] transition-all duration-500 ease-out cursor-pointer rounded-full ${
                currentTrainer === 1
                  ? "bg-orange-500"
