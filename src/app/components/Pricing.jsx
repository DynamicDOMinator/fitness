        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4 items-stretch">
          {plans.map((plan) => {
            ...
            return (
              ...
              >
                ...
                {plan.isPopular && (
                  <div className="absolute -top-1  left-1/2 transform -translate-x-1/2 z-10">
                    <span className="bg-gradient-to-r from-[#fd5747] via-red-500 to-red-700 text-white text-xs font-bold px-4 py-1 rounded-full animate-gradient-x shadow-lg" style={{backgroundSize: '200% 200%'}}>
                      Most Popular
                    </span>
                  </div>
                )}
                ...
                <div className="px-6 pt-6 flex-shrink-0">
                  ...
                  <div className="mt-3">
                    <div className="flex items-baseline">
                      <span className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#fd5747] to-red-600 animate-gradient-x" style={{backgroundSize: '200% 200%'}}>
              ...
              {/* Divider accent */}
              <div className="mt-6 h-px mx-6 bg-gradient-to-r from-[#fd5747]/50 via-white/10 to-red-600/50 animate-gradient-x" style={{backgroundSize: '200% 200%'}} />
              ...
              <div className="px-6 pb-6 flex-shrink-0">
                ...
                <div className="h-1 bg-gradient-to-r from-[#fd5747] via-white/10 to-red-600 animate-gradient-x" style={{backgroundSize: '300% 300%'}} />
              </div>
            );
          })}
        </div>
